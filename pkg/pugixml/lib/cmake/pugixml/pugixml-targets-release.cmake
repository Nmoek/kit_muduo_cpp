...
set_target_properties(pugixml::shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libpugixml.so.1.16"
  IMPORTED_SONAME_RELEASE "libpugixml.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS pugixml::shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_pugixml::shared "${_IMPORT_PREFIX}/lib/libpugixml.so.1.16" )
