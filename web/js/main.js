    ...
    protocolItem.innerHTML =`
        <div class="protocol-header">
            <div class="protocol-primary-row">
                ...
                <span class="protocol-name ${protocolInactive ? '' : 'editable inline-editable-title'}" data-default="Undef默认测试协议项">${escape(protocol.name)}</span>
        ...
        <div class="service-list-row">
            <div class="service-main-cell">
                <div class="service-primary-row">
                    <h3 class="service-title ${deleted ? '' : 'editable inline-editable-title'}" data-default="Undef默认测试服务">${escape(displayName)}</h3>
